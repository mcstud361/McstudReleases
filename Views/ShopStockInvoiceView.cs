...
/// <summary>
/// Shop Stock Invoice view with template-based customization.
...
/// </summary>
public class ShopStockInvoiceView : UserControl
{
    ...
    private void OnExportClick(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            var pdfData = new ShopStockInvoicePdfData
            {
            ...
            var pdfPath = ShopDocsPdfService.Instance.GenerateShopStockInvoicePdf(pdfData);

            // Track usage
            DocumentUsageTrackingService.Instance.RecordPdfExport("ShopStockInvoice", Path.GetFileName(pdfPath), 1);
            ...
            ShowNotification("Shop Stock Invoice exported successfully!", InfoBarSeverity.Success);
        }
        catch (Exception ex)
        {
