        ...
        private void LoadPartOperationMappings()
        {
            ...
            _partOperations["Quarter Panel"] = new PartOperationSet
            {
                ...
                Operations = new List<OperationRecommendation>
                {
                    ...
                    new("Welding Consumables", "Body", 0, true, "Wire, tips, gas") { IsMaterial = true, TypicalCost = 25 },
                    new("Weld-Through Primer", "Body", 0, true, "Corrosion protection") { IsMaterial = true, TypicalCost = 10 },
            ...
            _partOperations["Rocker Panel"] = new PartOperationSet
            {
                ...
                Operations = new List<OperationRecommendation>
                {
                    ...
                    new("Welding Consumables", "Body", 0, true, "") { IsMaterial = true, TypicalCost = 25 },
                    new("Weld-Through Primer", "Body", 0, true, "") { IsMaterial = true, TypicalCost = 10 },
                    new("Corrosion Protection", "Refinish", 0.3m, true, "Weld areas"),
            ...
            _partOperations["Front Bumper Cover"] = new PartOperationSet
            {
                ...
                Operations = new List<OperationRecommendation>
                {
                    ...
                    new("Flex Additive", "Refinish", 0, true, "") { IsMaterial = true, TypicalCost = 15 },
                    new("Stage and Secure", "Refinish", 0.2m, true, "")
                }
            };
            ...
            _partOperations["Windshield"] = new PartOperationSet
            {
                ...
                Operations = new List<OperationRecommendation>
                {
                    new("Pre-Repair Scan", "Diagnostic", 0, true, ""),
                    new("Post-Repair Scan", "Diagnostic", 0, true, ""),
                    new("Urethane Adhesive Kit", "Body", 0.8m, true, "") { IsMaterial = true, TypicalCost = 30 },
                    new("Glass Primer", "Body", 0.6m, true, "") { IsMaterial = true, TypicalCost = 20 },
            ...
            _partOperations["Radiator Support"] = new PartOperationSet
            {
                ...
                Operations = new List<OperationRecommendation>
                {
                    ...
                    new("Refrigerant", "Mechanical", 0, true, "") { IsMaterial = true, TypicalCost = 485 },
            ...
            _partOperations["Condenser"] = new PartOperationSet
            {
                ...
                Operations = new List<OperationRecommendation>
                {
                    ...
                    new("Refrigerant + Oil", "Mechanical", 0, true, "") { IsMaterial = true, TypicalCost = 485 },
